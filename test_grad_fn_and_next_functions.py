...
class TestAnonmousSurvey():
    ...
    def init_graph(self):
        ...
        self.grad_fn_1 = {"func_name": "GradNodeAccumulation", "next_funcs": {}}
        self.grad_fn_2 = {"func_name": "AddGradNode", 
                        "next_funcs": {
                            "GradNodeAccumulation": self.grad_fn_1
            }
        }
        self.output_grad_fn = {"grad_fn": self.grad_fn_2}
...
if __name__ == "__main__":
    # unittest.main()
    testcase = TestAnonmousSurvey()
    testcase.setUp()
    testcase.test_grad_fn_and_next_funs()
    print(23)